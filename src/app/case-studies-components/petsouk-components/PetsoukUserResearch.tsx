                ...
                <div className="container">
                    ...
                    <div className="grid grid-cols-2">
                        <div>
                            ...
                            <p className="text-blackgrey text-lg leading-relaxed mb-8">
                            ...
                            <ul className="list-disc text-blackgrey text-lg leading-relaxed mb-8">
                                <li>
            ...
            <section className="mt-3 petsouk-user-research pt-16">
                <div className="container">
                    <div className="ur_bottom">
                            ...
                            <ul className="list-disc text-blackgrey text-lg leading-relaxed">
                                <li>
